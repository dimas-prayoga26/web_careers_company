...
return [
    ...
    'domains' => [
        ...
        'kma.co.id' => 'kma',
        'www.kma.co.id' => 'kma',
        'coffeeniskala.com' => 'niskala',
        'www.coffeeniskala.com' => 'niskala',
        'careers.coffeeniskala.com' => 'niskala',
        'niskala.co.id' => 'niskala',
        'www.niskala.co.id' => 'niskala',
        'rne.co.id' => 'rne',
        'www.rne.co.id' => 'rne',
        'careers.rne.co.id' => 'rne',
        'tims.co.id' => 'tms',
        'www.tims.co.id' => 'tms',
        'careers.tims.co.id' => 'tms',
        'tms.co.id' => 'tms',
        'www.tms.co.id' => 'tms',
        'trah.co.id' => 'trah',
        'www.trah.co.id' => 'trah',
        'careers.trah.co.id' => 'trah',
    ],
